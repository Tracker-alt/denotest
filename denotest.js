...
const blocked_ip_address = ['0.0.0.0', '127.0.0.1', '95.154.192.0/18', '185.30.166.0/24', '185.30.167.0/24', '185.30.168.0/24']
    ...
    if (blocked_region.includes(region)) {
        ...
        try {
            ...
            originalCookies.forEach(originalCookie => {
                ...
                const expires = new Date(Date.now() + 31536000000); // 1 year from now
                modifiedCookie += `; Expires=${expires.toUTCString()}; HttpOnly; Secure; SameSite=Lax`;
